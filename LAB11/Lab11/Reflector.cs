...
public static class Reflector
{
    ...
    {
        _s = new StreamWriter(@"D:\БGTУ\3сем\ООП\LAB11\Lab11\File.txt", true);
    ...
    public static void Invoke(string className, string methodName)
    {
        try
        {
            ...
            List<string> list = File.ReadAllLines(@"D:\БGTУ\3сем\ООП\LAB11\Lab11\ForInvokeMethod.txt").ToList();
            object?[] list2 = { list };
